package org.logic_gates_book.ui.components
 ...
 */
@Composable
fun Tutorial(screenWidth: Float) {
    // Define los puntos de finalización para las zonas (izquierda, centro, derecha)
    val leftZoneEnd = screenWidth * 0.2f
    val centerZoneEnd = screenWidth * 0.8f  // El centro ocupa el 60% de la pantalla
    val rightZoneEnd = screenWidth
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            drawRect(
                ...
                topLeft = androidx.compose.ui.geometry.Offset(
                    leftZoneEnd,
                    0f
                ), // Comienza después de la zona izquierda
                size = androidx.compose.ui.geometry.Size(
                    centerZoneEnd - leftZoneEnd,
                    size.height
                ) // Zona central
            )
            ...
            drawRect(
                ...
                topLeft = androidx.compose.ui.geometry.Offset(
                    centerZoneEnd,
                    0f
                ), // Comienza después de la zona central
                size = androidx.compose.ui.geometry.Size(
                    rightZoneEnd - centerZoneEnd,
                    size.height
                ) // Zona derecha
            )
        }
